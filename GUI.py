...
ABBack.configure(background='#2A2B2D', foreground='#05ff8a', borderwidth=0, activebackground='#232426', pady=5, padx=10)
...
VNBack.configure(background='#2A2B2D', foreground='#05ff8a', borderwidth=0, activebackground='#232426', pady=5, padx=10)
...
VGBack.configure(background='#2A2B2D', foreground='#05ff8a', borderwidth=0, activebackground='#232426', pady=5, padx=10)
...
RC4Back.configure(background='#2A2B2D', foreground='#05ff8a', borderwidth=0, activebackground='#232426', pady=5, padx=10)
...
CNVBack.configure(background='#2A2B2D', foreground='#05ff8a', borderwidth=0, activebackground='#232426', pady=5, padx=10)
CNVEncrypt = Button(ConversorFrame, text='Text to Binary', command=lambda: GUI_Conversor("txt_to_bin"))
...
CNVDecrypt = Button(ConversorFrame, text='Binary to Text', command=lambda: GUI_Conversor("bin_to_txt"))
CNVDecrypt.place(x=175, y=355)
